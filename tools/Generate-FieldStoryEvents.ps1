...
Add-Definition -FieldId 190 -FieldName 'ealin_2' -Kind 'Location' -Label 'Approach Barret and Marlene upstairs' -EntityId 10 -X 86 -Y 30 -Z 288 -TargetGameMoment 257 -MinimumGameMoment 248 -MaximumGameMoment 256 -Priority 0 -RequiredCondition (New-Condition 3 65 0x01 0x00) -CompletedCondition (New-Condition 3 65 0x01 0x01) -EntityName 'ev' -ScriptType 'Move' -TriggerLine ([ordered]@{ startX = 22; startY = 60; startZ = 288; endX = 150; endY = 0; endZ = 288 }) -KeepActiveOnArrival
...
Add-Definition -FieldId 188 -FieldName 'ealin_1' -Kind 'Location' -Label "Leave Aeris's house to plan her rescue" -EntityId 13 -X -170 -Y -138 -Z 0 -TargetGameMoment 257 -MinimumGameMoment 248 -MaximumGameMoment 256 -Priority 0 -RequiredCondition (New-Condition 3 65 0x01 0x01) -EntityName 'ev' -ScriptType 'Move' -TriggerLine ([ordered]@{ startX = -232; startY = -110; startZ = 0; endX = -109; endY = -166; endZ = 0 }) -KeepActiveOnArrival
Add-Definition -FieldId 189 -FieldName 'ealin_12' -Kind 'Location' -Label "Leave Aeris's house to plan her rescue" -EntityId 13 -X -170 -Y -138 -Z 0 -TargetGameMoment 257 -MinimumGameMoment 248 -MaximumGameMoment 256 -Priority 0 -RequiredCondition (New-Condition 3 65 0x01 0x01) -EntityName 'ev' -ScriptType 'Move' -TriggerLine ([ordered]@{ startX = -232; startY = -110; startZ = 0; endX = -109; endY = -166; endZ = 0 }) -KeepActiveOnArrival
...
# floor to its normal Story route.
...
Add-Definition -FieldId 245 -FieldName 'blin63_1' -Kind 'Location' -Label 'Enter the A Coupon room duct' -EntityId 46 -X -864 -Y 119 -Z 0 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredCondition (New-Condition 3 177 0x02 0x02) -CompletedCondition (New-Condition 3 172 0x40 0x40) -EntityName 'DUCTLB' -ScriptType 'Move' -KeepActiveOnArrival
Add-Definition -FieldId 246 -FieldName 'blin63_t' -Kind 'Location' -Label 'Crawl to the shaft for the B Coupon room' -X 384 -Y 123 -Z 369 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredCondition (New-Condition 3 177 0x02 0x02) -CompletedCondition (New-Condition 3 172 0x40 0x40) -EntityName 'CLOUD' -ScriptType 'LADER' -KeepActiveOnArrival
Add-Definition -FieldId 245 -FieldName 'blin63_1' -Kind 'Model' -Label 'Collect the B Coupon' -EntityId 44 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredCondition (New-Condition 3 172 0x40 0x40) -CompletedCondition (New-Condition 3 177 0x08 0x08) -EntityName 'TAKARA3' -ScriptType 'Talk'
Add-Definition -FieldId 245 -FieldName 'blin63_1' -Kind 'Location' -Label 'Open coupon route door 3 of 3' -X 10 -Y -42 -Z 0 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredCondition (New-Condition 3 177 0x08 0x08) -CompletedCondition (New-Condition 3 175 0x08 0x08) -EntityName 'D12' -ScriptType '[OK]' -KeepActiveOnArrival
Add-Definition -FieldId 245 -FieldName 'blin63_1' -Kind 'Model' -Label 'Collect the C Coupon' -EntityId 43 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredCondition (New-Condition 3 175 0x08 0x08) -CompletedCondition (New-Condition 3 177 0x04 0x04) -EntityName 'TAKARA2' -ScriptType 'Talk'
Add-Definition -FieldId 245 -FieldName 'blin63_1' -Kind 'Location' -Label 'Enter the B Coupon room duct' -EntityId 47 -X 340 -Y 100 -Z 0 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredCondition (New-Condition 3 177 0x0E 0x0E) -CompletedCondition (New-Condition 3 172 0x80 0x80) -EntityName 'DUCTLC' -ScriptType 'Move' -KeepActiveOnArrival
Add-Definition -FieldId 246 -FieldName 'blin63_t' -Kind 'Location' -Label 'Crawl to the floor 63 computer shaft' -X 644 -Y -501 -Z 369 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredCondition (New-Condition 3 177 0x0E 0x0E) -CompletedCondition (New-Condition 3 172 0x80 0x80) -EntityName 'CLOUD' -ScriptType 'LADER' -KeepActiveOnArrival
Add-Definition -FieldId 245 -FieldName 'blin63_1' -Kind 'Model' -Label 'Exchange the Floor 63 coupons at the computer' -EntityId 15 -TargetGameMoment 264 -MinimumGameMoment 263 -MaximumGameMoment 263 -Priority -1 -RequiredConditions @((New-Condition 3 177 0x0E 0x0E), (New-Condition 3 172 0x80 0x80)) -CompletedCondition (New-Condition 3 181 0x80 0x80) -EntityName 'MLINE' -ScriptType '[OK]'
