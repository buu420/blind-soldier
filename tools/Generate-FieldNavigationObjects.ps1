...
Add-Definition -FieldId 245 -FieldName 'blin63_1' -EntityId 44 -EntityName 'TAKARA3' -ModelResource 'blin63_1fieldbg_zuta_orig.char' -Kind 'Named' -Label 'B Coupon' -CollectedBank 3 -CollectedAddress 177 -CollectedMask 0x08 -RequiredBank 3 -RequiredAddress 172 -RequiredMask 0x40 -RequiredValue 0x40 -MaximumGameMoment 1007
Add-Definition -FieldId 245 -FieldName 'blin63_1' -EntityId 45 -EntityName 'DUCTLA' -ModelResource '' -Kind 'Named' -Label 'Computer-room duct exit; cannot enter from this side' -TargetKind 'Line' -StaticX 771 -StaticY -607 -StaticZ 0 -RequiredBank 3 -RequiredAddress 172 -RequiredMask 0x80 -RequiredValue 0x80 -MaximumGameMoment 1007
Add-Definition -FieldId 245 -FieldName 'blin63_1' -EntityId 46 -EntityName 'DUCTLB' -ModelResource '' -Kind 'Named' -Label 'A Coupon room duct entrance' -TargetKind 'Line' -StaticX -864 -StaticY 119 -StaticZ 0 -CollectedBank 3 -CollectedAddress 172 -CollectedMask 0x40 -RequiredBank 3 -RequiredAddress 177 -RequiredMask 0x02 -RequiredValue 0x02 -MaximumGameMoment 1007
Add-Definition -FieldId 245 -FieldName 'blin63_1' -EntityId 47 -EntityName 'DUCTLC' -ModelResource '' -Kind 'Named' -Label 'B Coupon room duct entrance' -TargetKind 'Line' -StaticX 340 -StaticY 100 -StaticZ 0 -CollectedBank 3 -CollectedAddress 172 -CollectedMask 0x80 -RequiredBank 3 -RequiredAddress 177 -RequiredMask 0x04 -RequiredValue 0x04 -MaximumGameMoment 1007
...
Add-Definition -FieldId 246 -FieldName 'blin63_t' -EntityId 6 -EntityName 'CLOUD' -ModelResource '' -Kind 'Named' -Label 'Backtrack shaft to A Coupon room' -TargetKind 'Location' -StaticX -827 -StaticY 124 -StaticZ 369 -CollectedBank 3 -CollectedAddress 172 -CollectedMask 0x20 -RequiredBank 3 -RequiredAddress 177 -RequiredMask 0x02 -RequiredValue 0x02 -MaximumGameMoment 1007
Add-Definition -FieldId 246 -FieldName 'blin63_t' -EntityId 6 -EntityName 'CLOUD' -ModelResource '' -Kind 'Named' -Label 'Shaft to B Coupon room' -TargetKind 'Location' -StaticX 384 -StaticY 123 -StaticZ 369 -CollectedBank 3 -CollectedAddress 172 -CollectedMask 0x40 -RequiredBank 3 -RequiredAddress 177 -RequiredMask 0x02 -RequiredValue 0x02 -MaximumGameMoment 1007
Add-Definition -FieldId 246 -FieldName 'blin63_t' -EntityId 6 -EntityName 'CLOUD' -ModelResource '' -Kind 'Named' -Label 'Shaft to floor 63 computer room' -TargetKind 'Location' -StaticX 644 -StaticY -501 -StaticZ 369 -CollectedBank 3 -CollectedAddress 172 -CollectedMask 0x80 -RequiredBank 3 -RequiredAddress 177 -RequiredMask 0x0E -RequiredValue 0x0E -MaximumGameMoment 1007
